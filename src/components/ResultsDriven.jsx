...
const ResultsDriven = () => {
  return (
      <div className="flex flex-wrap justify-between relative flex-row -mx-3">
          <div className="absolute xl:top-[14%] lg:top-[18%] lg:block hidden xl:right-[44%] right-[48%]"><Arrow/></div>
          <div className="md:w-1/2 w-full px-3">
            <H5
              className="uppercase md:text-start xl:mb-1 text-center"
            ...
            <div className="flex max-lg:flex-col items-center xl:items-end">
              <img
                className="w-full lg:max-w-[378px] lg:max-h-[294px] h-full lg:mt-6 mt-3"
                src={cardImage}
                alt="cardimage"
              />
            </div>
          ...
          <div className="md:w-1/2 md:mb-3 w-full md:pt-0 pt-3 px-3 flex items-end justify-end">
            <div className="mb-0">
                <Description
                  ...
                  description={
                    <>
                      ...
                      with their companies. Regardless of what the goal is, whether
                      to increase sales, increase brand awareness or attract new
                      employees. We always look for the{" "}
                      {
                        <span className="text-skyBlue text-opacity-100">
                ...
                />
                <div className="mb-0 flex md:justify-start justify-center">
                  <CommonButton className="lg:mt-10 md:mt-8 sm:mt-6 mt-3" name="Contact" />
                </div>
            </div>
          </div>
        </div>

  ...
  return (
    <div className="px-6 relative z-[1] sm:pt-12 pt-10 xl:pt-36 lg:pt-24 md:pt-16 pb-[3px]">
      <div className="container max-w-[1164px]">
        ...
        <div className={`flex flex-row flex-wrap justify-center py-6 -mx-3 xl:py-28 lg:py-24 sm:py-8 md:py-16 xl:my-3 ${padding}`}>
          {howWeWorkList.map((obj, i) => (
            <div key={i} className="flex justify-center w-full px-2 lg:w-1/3 sm:w-1/2">

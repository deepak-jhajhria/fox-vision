...
export const PortfolioCardLayout = (props) => {
  return (
    <div className='lg:max-w-[364px] max-md:max-w-[364px] w-full rounded-md border border-solid border-lightGrey'>
      ...
      <div className='px-[15px] pb-[15px]'>
        ...
        <p className='font-poppins text-sm lg:text-base leading-150 text-comet'>{props.discription}</p>
      </div>
    </div>
  )
}

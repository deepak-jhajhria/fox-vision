...
export const H2 = ({ heading, className }) => {
  return <h2 className={`font-montserrat font-semibold text-blackPearl text-4xl sm:text-custom-4xl md:text-5xl lg:text-custom-6xl lg:!leading-[78.2px] ${className}`}>{heading}</h2>
}

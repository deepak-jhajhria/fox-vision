...
export const FacebookIcon = () => {
  return (
    ...
    <path d="M3.18027 21.7288H7.64507V12.788H11.6678L12.1099 8.34555H7.64507V6.10199C7.64507 5.80595 7.76266 5.52205 7.97199 5.31272C8.18132 5.10339 8.46523 4.98579 8.76126 4.98579H12.1099V0.520996H8.76126C7.28109 0.520996 5.86155 1.10899 4.81491 2.15563C3.76827 3.20227 3.18027 4.62182 3.18027 6.10199V8.34555H0.947874L0.505859 12.788H3.18027V21.7288Z" fill="white"/>
    </svg>
...
<div className="flex gap-4 justify-center lg:justify-start">
    <a href="https://www.facebook.com/"  target='blank' rel='noopener norefferer'> 
        <div className='w-10 h-10 border border-solid border-white rounded-full flex justify-center items-center'>
            <FacebookIcon/>
        </div>
    </a>
...
<div className="flex lg:gap-[75px] lg:max-w-[548.21px] w-full lg:justify-end flex-wrap  flex-row">
    <div className='lg:max-w-[71px] w-1/2  min-[500px]:!w-1/3 flex min-[500px]:justify-center lg:block'>
        <ul>
            ...
            </li>
            {
                FooterLinkData.data1.map((data,i)=> (  <li key={i} className='mb-3 ' >
                        <a href={data.path} className='font-poppins  text-base font-normal text-white text-opacity-70'>
                            {data.link}
                        </a>
                    </li>
                ))
    ...
    <div className='lg:max-w-[201.21px] w-1/2  min-[500px]:w-1/3'>
        <ul>
            <li className='font-poppins text-base  font-semibold text-white mb-[14px]'>
            Agency
            </li>
...
<div className='lg:max-w-[126px] w-full min-[500px]:w-1/3'>
    <ul >
        <li className='font-poppins  text-base font-semibold text-white mb-[14px]'>
        Legal
        </li>

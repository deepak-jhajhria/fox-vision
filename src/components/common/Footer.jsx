...
export const FacebookIcon = () => {
    return (
        <svg width="13" height="22" viewBox="0 0 13 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.18027 21.7288H7.64507V12.788H11.6678L12.1099 8.34555H7.64507V6.10199C7.64507 5.80595 7.76266 5.52205 7.97199 5.31272C8.18132 5.10339 8.46523 4.98579 8.76126 4.98579H12.1099V0.520996H8.76126C7.28109 0.520996 5.86155 1.10899 4.81491 2.15563C3.76827 3.20227 3.18027 4.62182 3.18027 6.10199V8.34555H0.947874L0.505859 12.788H3.18027V21.7288Z" fill="white" className='duration-300 group-hover:fill-blue' />
        </svg>
                    ...
                    <div className="w-full px-3 mb-10 lg:w-5/12 lg:mb-0">
                        ...
                        <div className="flex justify-center gap-4 lg:justify-start">
                            <a href="https://www.facebook.com/" target='blank' rel='noopener norefferer'>
                                <div className='flex items-center justify-center w-10 h-10 duration-300 border border-white border-solid rounded-full group hover:border-blue'>
                                    <FacebookIcon />
                                </div>
                            </a>
                                ...
                                <ul>
                                    ...
                                    </li>
                                    {
                                        FooterLinkData.data1.map((data, i) => (<li key={i} className='mb-3 ' >
                                            <Link to={data.path} className='text-base font-normal text-white font-poppins footerLinkHover text-opacity-70'>
                                                {data.link}
                                            </Link>
                                        </li>
                                        ))
                                ...
                                <ul >
                                    ...
                                    </li>
                                    {
                                        FooterLinkData.data3.map((data, i) => (<li key={i} className='mb-3 '>
                                            <a href={data.path} className='text-base font-normal text-white font-poppins footerLinkHover text-opacity-70'>
                                                {data.link}
                                            </a>
                                        </li>
                                        ))

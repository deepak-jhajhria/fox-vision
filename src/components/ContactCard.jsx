...
"
      ...
      <h4 className="font-poppins text-2xl leading-[150%] font-semibold text-[#071838] text-center mb-[15px]">
        {props.title}
      </h4>
      <p
        className={` 
      font-poppins text-black text-base font-normal text-center max-w-[304px] mx-auto`}
      >
        {props.value}
      </p>
    </div>
